...
|----|-------|------|------|------|--------|
| T-001 | - | CLI 命令注册与诊断框架基础 | todo | - | dev |
| T-002 | ST-001 | 结构合规性检查器 | todo | T-001 | dev |
| T-003 | ST-001 | 元数据合规性检查器 | todo | T-001 | dev |
| T-004 | ST-001 | 边界合规性检查器 | todo | T-001 | dev |
| T-005 | ST-001 | 标准合规性检查器 | todo | T-001 | dev |
| T-006 | ST-001 | 格式合规性检查器 | todo | T-001 | dev |
| T-007 | ST-001 | 评测合规性检查器 | todo | T-001 | dev |
| T-008 | ST-001 | 兼容性合规性检查器 | todo | T-001 | dev |
| T-009 | ST-002 | 量化评分引擎 | todo | T-001 | dev |
| T-010 | ST-003 | Markdown 诊断报告生成器 | todo | T-009 | dev |
| T-011 | ST-004 | 改造清单生成器 | todo | T-009 | dev |
| T-012 | ST-005 | 批量诊断与汇总报告 | todo | T-010, T-011 | dev |
| T-013 | ST-006 | 可标准化问题自动修复引擎 | todo | T-011 | dev |
